...
export function registerAdvisoryTools(server) {
    ...
    server.registerTool('dawinos_list_project_funds', {
...
|------|------|--------|--------|-------|-----------|-----------|----------------|`;
    ...
    server.registerTool('dawinos_get_project_fund', {
...
${accountabilitySection}`;
    ...
    server.registerTool('dawinos_project_expenditures', {
...
|---------|------|--------|--------|--------|-------------|`;
    ...
    server.registerTool('dawinos_accountability_summary', {
