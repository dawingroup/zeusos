...
export declare const MATFLOW_PATHS: {
    readonly formulas: "matflow/data/formulas";
    readonly materials: "advisoryPlatform/matflow/materials";
};
...
export declare const ADVISORY_PATHS: {
    readonly projects: (orgId?: string) => string;
    readonly allocationGroups: (orgId?: string) => string;
    readonly programs: (orgId?: string) => string;
};
...
export declare const ADVISORY_PROJECT_STATUSES: readonly ["planning", "procurement", "mobilization", "active", "substantial_completion", "defects_liability", "completed", "suspended", "cancelled"];
export declare const ALLOCATION_GROUP_STATUSES: readonly ["Draft", "Finalized"];
