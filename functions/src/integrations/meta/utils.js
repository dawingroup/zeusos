/**
 * Meta WhatsApp Integration - Shared Utilities
 * Phone number normalization and helper functions
 *
 * Identical to Zoko utils - Meta also requires international format without '+'
 */

/**
 * Normalize a phone number to a format suitable for Meta Cloud API
