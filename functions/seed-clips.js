/**
 * Seed Test Clips using Firebase Admin
 * Run from functions folder: node seed-clips.js <userId>
 */
...
if (!userId) {
  console.log('Usage: node seed-clips.js <userId>\n');
  console.log('To find your userId, sign in to the app and run in console:');
  console.log('  firebase.auth().currentUser.uid');
  process.exit(1);
}

seedClips(userId).catch(err => {
