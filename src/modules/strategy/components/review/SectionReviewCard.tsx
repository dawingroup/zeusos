...
export const SectionReviewCard: React.FC<SectionReviewCardProps> = ({
  ...
  const statusColor = REVIEW_SECTION_STATUS_COLORS[review.status] || 'bg-[var(--bg-sunken)] text-muted-foreground';
  ...
  return (
    <div className="bg-card border border-[var(--border-subtle)] rounded-xl shadow-sm overflow-hidden">
      {/* Header */}
      <div
        className="flex items-center justify-between px-5 py-4 cursor-pointer hover:bg-[var(--bg-sunken)] transition-colors"
