/**
 * Hook for subscribing to outsourced purchase orders list
 */
...
interface UseOutsourcedPurchaseOrdersResult {
...
export function useOutsourcedPurchaseOrders(
  subsidiaryId: string,
  filters?: Omit<POFilters, 'purchaseOrderType'>,
): UseOutsourcedPurchaseOrdersResult {
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeToPurchaseOrders(
      { ...filters, purchaseOrderType: 'outsourced', subsidiaryId },
      (fetchedOrders) => {
