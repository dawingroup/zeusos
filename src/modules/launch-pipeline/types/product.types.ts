...
export interface LaunchProduct {
  ...
  // Clipper integration
  sourceClipId?: string;         // Firestore ID of the originating design clip
  sourceClipUrl?: string;        // Source URL of the clipped page
  clipImageUrl?: string;         // Image from the clip (for reference)
