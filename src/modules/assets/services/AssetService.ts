...
export class AssetService {
  ...
  async logMaintenance(
    ...
    // Create maintenance log entry — strip undefined values (Firestore rejects them)
    const logEntry = stripUndefined({
      assetId,
      ...
      consumablesUsed: maintenanceData.consumablesUsed,
