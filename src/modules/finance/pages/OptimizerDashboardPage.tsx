// ============================================================================
// OPTIMIZER DASHBOARD PAGE
// Cash position, 90-day chart, today's spend plan summary, critical items
// ============================================================================
...
export function OptimizerDashboardPage() {
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-gray-900">Optimizer Dashboard</h2>
        </div>
...
export default OptimizerDashboardPage;
