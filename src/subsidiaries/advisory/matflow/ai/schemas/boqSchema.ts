...
export interface ParsedBOQItem {
  ...
  // ---- Hierarchy fields (extracted from item code dot-segments) ----
  /** Hierarchy level: 1=Bill, 2=Element, 3=Section, 4=WorkItem */
  hierarchyLevel?: number;
  /** Whether this is a header row (level 1-3 with no quantity data) */
  isHeaderRow?: boolean;
  /** Parent item code (e.g., "2.1.1" for item "2.1.1.1") */
  parentCode?: string;

  // ---- AI Enhancement fields (populated by Claude Cloud Function) ----
  /** AI-enhanced standardized description */
  aiDescription?: string;
  /** AI-detected material type */
  aiMaterialType?: string;
  /** AI-detected material grade */
  aiMaterialGrade?: string;
