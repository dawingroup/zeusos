  ...
  return (
    <header className="bg-gradient-to-r from-[#872E5C] to-[#6B2549] px-4 py-3 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 bg-card/20 backdrop-blur rounded-xl flex items-center justify-center ring-2 ring-white/30">
          <span className="text-white font-bold text-base">D</span>
        </div>
        <div>
          <h1 className="text-sm font-semibold text-white flex items-center gap-1.5">
            Dawin Clipper
            <span className="text-[10px] bg-card/20 px-1.5 py-0.5 rounded-full font-normal">v1.0</span>
          </h1>
