...
const variantStyles = {
  ...
  purple: {
    header: 'bg-[var(--rag-blue-soft)] border-[var(--rag-blue)]',
    headerText: 'text-[var(--rag-blue)]',
    row: 'hover:bg-[var(--rag-blue-soft)]/50',
    rowSelected: 'bg-[var(--rag-blue-soft)]',
    border: 'border-[var(--rag-blue)]',
    divider: 'divide-[var(--rag-blue)]',
    cardBorder: 'border-[var(--rag-blue)]',
  },
  green: {
