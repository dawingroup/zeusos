...
- 🟡 **ADR-2026-05-25** — Commercial model: §15.5 resolutions. See [`docs/ADR-2026-05-25-commercial-model.md`](docs/ADR-2026-05-25-commercial-model.md). Separate legal entities (Q1) · brand-direct sales with `primaryBrandId` precedence (Q2 — reverses the "subsidiary never quotes" invariant) · cost-plus IC markup (Q3) · named-competitor list per client (Q4 — retires the 6.C category model; PRs #78 + #83 closed). Reshape plan: 6 ordered steps; mutating agents stay `draft_only` until steps 1–5 land.
